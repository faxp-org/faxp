...
5. Detention commercial policy terms as booking metadata (for example grace period, hourly amount, billing increment, and delay/location evidence intent).
6. Multi-stop terms as booking commitments (ordered pickup/drop plan, stop-count expectations, and stop-plan acceptance/counter semantics).
7. Carrier acceptance of these terms in booking negotiation.
8. Execution report snapshot of the agreed commercial terms.
