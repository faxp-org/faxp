...
| Replay incident runbook reviewed and approved | truckingadvantage | 2026-03-16 | Done | `docs/governance/REPLAY_INCIDENT_RUNBOOK.md`, `docs/governance/REPLAY_INCIDENT_DRILL_EVIDENCE_2026-03-16.md`, `scripts/incident_drill.sh`, `tests/run_replay_incident_artifacts.py` |
...
<!-- RELEASE_READINESS_REQUIREMENTS_BEGIN -->
{
  ...
  "requiredTests": [
    ...
    "tests/run_beta_roadmap_sync.py",
    "tests/run_second_implementer_evidence_bundle_template.py",
    "tests/run_roadmap_status_sync.py",
