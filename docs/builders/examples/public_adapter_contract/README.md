# Public Adapter Contract Examples

These examples are synthetic and anonymized.

Use them to understand:
1. what the adapter emits into FAXP, and
2. what the adapter consumes from FAXP to update builder-native records.
