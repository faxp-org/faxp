#!/usr/bin/env python3
"""Verify protocol compatibility profile signature and fail closed on tampering."""
...
KEYRING_PATH = PROJECT_ROOT / "conformance" / "protocol_compatibility_keys.sample.json"
...
def main() -> int:
    ...
    matrix = tampered.get("compatibilityMatrix") or {}
    matrix["0.1.1"]["0.2.0"] = "Compatible"
    tampered["compatibilityMatrix"] = matrix
    try:
    ...
    print("Protocol compatibility profile signature checks passed.")
    return 0
