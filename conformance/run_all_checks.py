...
def _suite_commands() -> list[tuple[str, list[str]]]:
    ...
    return [
        ...
        (
            "roadmap_status_sync",
            [python, str(TESTS_DIR / "run_roadmap_status_sync.py")],
        ),
        (
            "adoption_execution_runbook",
            [python, str(TESTS_DIR / "run_adoption_execution_runbook.py")],
        ),
        ...
        ("a2a_watch_artifacts", [python, str(TESTS_DIR / "run_a2a_watch_artifacts.py")]),
        ...
        ("interop_maturity_profile", [python, str(TESTS_DIR / "run_interop_maturity_profile.py")]),
        ...
        ("driver_configuration_terms", [python, str(TESTS_DIR / "run_driver_configuration_terms.py")]),
        (
        ...
        (
            ...
            [python, str(TESTS_DIR / "run_composite_booking_scenarios.py")],
        ),
