...
Verification policy profile check:

```bash
python3 tests/run_verification_policy_profile.py
```

Verification policy decision matrix check:

```bash
python3 tests/run_policy_decisions.py
```

Policy profile doc/test sync check:
...
```bash
python3 tests/run_multi_stop_terms.py
```

Multi-stop commercial-term profile check:

```bash
python3 tests/run_multi_stop_terms_profile.py
```

Special-instructions commercial-term check:

```bash
python3 tests/run_special_instructions_terms.py
```

Special-instructions commercial-term profile check:
...
```bash
python3 tests/run_equipment_terms.py
```

Equipment taxonomy profile check:
